...
export class TrxParser {
  ...
  public static async parseTRXFileAsync(trxFilePath: string): Promise<IUnitTestResult[]> {
          ...
          if (
            ...
            testResults.forEach((testResult: any) => {
              ...
              unitTestResults.push({
                ...
                startTime: moment(testResult.$.endTime).subtract(this.convertTimeToSeconds(testResult.$.duration), 'seconds').toDate(),
