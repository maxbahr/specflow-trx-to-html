...
export class TestResultPreparing {
    ...
    public static async prepareUnitTestResult(trxFiles: string[], attachmentFiles: string[]): Promise<IUnitTestResult[]> {
    ...
    public static prepareSummaryResult(unitTestResults: IUnitTestResult[], summaryDomainResult: ISummaryResult[]): ISummaryResult {
    ...
    public static prepareDomainSummaryResult(data: IUnitTestResult[]): ISummaryResult[] {
